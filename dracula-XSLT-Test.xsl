...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   * Prepare CSS to style your HTML. The XSLT should output the CSS link line to your CSS file accurately. 
                ...
                <section id="contents"> 
                    <table> 
                        ...
                        <tr>
                            ...
                            <td><a href="#CH{count(preceding::heading)+1}"><xsl:apply-templates select="descendant::heading"/></a></td>
                            
                            <!--jimin: using mode="toc" to connects to the heading template that doesn't have h2 element-->
    ...
    <xsl:template match="chapter">
        ...
        <div>
            <h2 id="CH{count(preceding::heading)+1}">
            <xsl:apply-templates select="heading"/>
        </h2>
           <div class="body_paragraph"> <xsl:apply-templates select="p"/></div>
        </div>
    </xsl:template>
